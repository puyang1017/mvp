package com.android.puy.puymvpjava.kit;
...
public class Kits {
    ...
    public static class NetWork {
        ...
        public static final String NETWORK_TYPE_WIFI_5G = "Wi-Fi-5G";
        public static final String NETWORK_TYPE_WIFI_24G = "Wi-Fi-2.4G";
         ...
         * @return
         */
        public static String checkWifiGHz(int freq) {
            if (freq > 2400 && freq < 2500) {
                return NETWORK_TYPE_WIFI_24G;
            } else if (freq > 4900 && freq < 5900) {
                return NETWORK_TYPE_WIFI_5G;
            } else {
        ...
        public static boolean isWifi(Context context){
            switch (getNetworkTypeName(context)){
                case NETWORK_TYPE_WIFI:
                case NETWORK_TYPE_WIFI_5G:
                case NETWORK_TYPE_WIFI_24G:
                    return true;
            ...
            if (networkInfo.isConnected()) {
                ...
                if (netType == ConnectivityManager.TYPE_WIFI) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && wifiInfo != null) {
                        type = checkWifiGHz(wifiInfo.getFrequency());
                    } else {
